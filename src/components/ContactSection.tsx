...
export default function ContactSection() {
    ...
    return (
        <section className={`relative py-16 overflow-hidden ${theme === 'dark'
                ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900'
                : 'bg-gradient-to-br from-gray-50 via-white to-gray-50'
            }`}>
            {/* Background Pattern */}
            <div className={`absolute inset-0 opacity-10 ${theme === 'dark'
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                >
                    <div className="text-center mb-20">
                        <motion.h2
                            className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-6"
                    ...
                    <div className="grid lg:grid-cols-[1.2fr_2fr] gap-12">
                        {/* Contact Info Card */}
                        <motion.div
                            className={`rounded-3xl p-8 border shadow-2xl ${theme === 'dark'
                        ...
                        >
                            ...
                            {/* Social Links */}
                            <div className={`mt-10 pt-8 border-t ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'
                                }`}>
                                <h4 className={`text-lg font-semibold ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                                    } mb-6`}>
                                    Follow Me
                                </h4>
...
function ContactItem({ icon: Icon, text, link, theme }) {
    return (
        <motion.a
            href={link || "#"}
            className={`flex items-center gap-4 p-4 rounded-xl transition-all group ${theme === 'dark'
                    ? 'bg-gray-700/30 hover:bg-gray-700/50'
                    : 'bg-gray-100 hover:bg-gray-200'
                }`}
            whileHover={{ x: 5 }}
        >
            <div className="p-3 bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 rounded-lg">
...
function ContactForm({ theme }) {
    return (
        <form className="space-y-6">
            ...
            <motion.button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-500  via-purple-700 text-white py-4 rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-600 transition-all"
    ...
    return (
        <div>
            ...
            {type === "textarea" ? (
                <textarea
                    rows={4}
                    className={`w-full px-4 py-3 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-400 resize-none ${theme === 'dark'
                ...
                <input
                    type={type}
                    className={`w-full px-4 py-3 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-400 ${theme === 'dark'
                            ? 'bg-gray-700/30 border border-gray-700 text-white'
                            : 'bg-gray-100 border border-gray-200 text-gray-900'
                        }`}
                    placeholder={placeholder}
