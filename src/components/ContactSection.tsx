            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                >
                    <div className="text-center mb-16 lg:mb-24">
                        <motion.h2
                            className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-800 to-cyan-500 dark:from-cyan-500 dark:to-cyan-400 bg-clip-text text-transparent mb-6"
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        >
                            ...
                            <div className="mt-10 pt-8 border-t border-gray-200 dark:border-gray-700">
                                <h4 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-6">
                                    Connect Online
                                </h4>
...
function ContactItem({ icon: Icon, text, link }) {
    return (
        <motion.a
            href={link}
            className="flex items-center gap-4 p-4 rounded-xl transition-all group hover:bg-gray-50 dark:hover:bg-gray-700/50"
            whileHover={{ x: 5 }}
        >
            <div className="p-3 bg-cyan-600 dark:bg-cyan-500 rounded-lg group-hover:bg-cyan-700 dark:group-hover:bg-cyan-400 transition-colors">
...
function SocialLink({ icon: Icon, href }) {
    return (
        <motion.a
            href={href}
            className="p-3 rounded-lg transition-all hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 hover:text-cyan-600 dark:hover:text-cyan-400"
            whileHover={{ y: -3 }}
        >
...
function ContactForm() {
    ...
    return (
        <form className="space-y-6">
            ...
            <motion.button
                type="submit"
                className="w-full flex items-center justify-center gap-3 bg-cyan-600 dark:bg-cyan-500 text-white py-4 rounded-xl font-semibold hover:bg-cyan-700 dark:hover:bg-cyan-400 transition-colors"
    ...
    return (
        <div>
            ...
            {type === "textarea" ? (
                <textarea
                    rows={4}
                    className={`w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent placeholder-gray-400 resize-none transition-all ${theme === 'dark'
                ...
                <input
                    type={type}
                    className={`w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent placeholder-gray-400 transition-all ${theme === 'dark'
                            ? 'bg-gray-700 border border-gray-600 text-white'
                            : 'bg-gray-50 border border-gray-200 text-gray-900'
                        }`}
                    placeholder={placeholder}
